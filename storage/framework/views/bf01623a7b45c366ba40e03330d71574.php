<header class="header-top" header-theme="light">
    <div class="container-fluid">
        <div class="d-flex justify-content-between">
            ...
            <p style="color:red;"><?php echo e(isset($data['withdraw_log']) ? $data['withdraw_log']->field_value : ''); ?></p>
            <div class="top-menu d-flex align-items-center">
                <!-- <div class="dropdown">
                ...
                <div class="dropdown">
                    <a class="dropdown-toggle" href="#" id="userDropdown" role="button"
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img class="avatar"
                            src="<?php echo e(asset('img/user.jpg')); ?>" alt=""></a>
...
<?php /**PATH C:\Web\sample-project\resources\views/include/header.blade.php ENDPATH**/ ?>