		...
		<div class="container">
		    <div class="row justify-content-center">
		        <div class="col-md-12 m-5 text-center">
		        	<a href="http://rakibul.
		            	<img height="40" src="<?php echo e(asset('img/logo.png')); ?>">
		            </a>
		        </div>
		        <div class="col-md-12 m-5 mt-0 text-center">
		            ...
		            <a href="<?php echo e(url('login')); ?>" class="btn btn-success">Go to Admin</a>
...
<?php /**PATH C:\Web\sample-project\resources\views\home.blade.php ENDPATH**/ ?>