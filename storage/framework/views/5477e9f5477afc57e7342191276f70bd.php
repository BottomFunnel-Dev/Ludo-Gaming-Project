...
<div class="accordion">
    ...
    <div class="accordion-item">
        <h2 class="accordion-header">
        <a href="<?php echo e(URL('refund-and-cancellation-policy')); ?>">
...
<?php echo $__env->make('layouts.front.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Web\sample-project\resources\views\user\legal.blade.php ENDPATH**/ ?>