            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5><?php echo e(__('Widgets Basic')); ?></h5>
                ...
                <div class="col-lg-4">
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><?php echo e(__('Widgets Basic')); ?></li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <ul class="chat-list">
                            <li class="chat-item">
                                ...
                                <div class="chat-content">
                                    <h6 class="font-medium"><?php echo e(__('James Anderson')); ?></h6>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Web\sample-project\resources\views\pages\widgets.blade.php ENDPATH**/ ?>