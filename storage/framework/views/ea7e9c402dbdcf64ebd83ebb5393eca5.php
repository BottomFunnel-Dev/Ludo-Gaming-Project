...
<?php $__env->startSection('title', 'Widget Statistic'); ?>
    ...
    <div class="container-fluid">
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5><?php echo e(__('Widget Statistic')); ?></h5>
                ...
                <div class="col-lg-4">
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><?php echo e(__('Widget Statistic')); ?></li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-xl-12">
                <div class="card proj-progress-card">
                    <div class="card-block">
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <h6><?php echo e(__('Published Project')); ?></h6>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <h6><?php echo e(__('Completed Task')); ?></h6>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <h6><?php echo e(__('Successfull Task')); ?></h6>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <h6><?php echo e(__('Ongoing Project')); ?></h6>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card social-res-card">
                    <div class="card-header">
                        <h5><?php echo e(__('Facebook Source')); ?></h5>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card social-res-card">
                    <div class="card-header">
                        <h5><?php echo e(__('Twitter Source')); ?></h5>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card social-res-card">
                    <div class="card-header">
                        <h5><?php echo e(__('Google+ Source')); ?></h5>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card social-res-card">
                    <div class="card-header">
                        <h5><?php echo e(__('Linkedin Source')); ?></h5>
                    </div>
                    <div class="card-body">
                        <p class="mb-10">Profile</p>
                        <div class="progress mb-30">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Web\sample-project\resources\views\pages\widget-statistic.blade.php ENDPATH**/ ?>