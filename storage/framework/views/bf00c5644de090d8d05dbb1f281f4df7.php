...
<?php $__env->startSection('title', 'Room Codes'); ?>
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5><?php echo e(__('Room Codes')); ?></h5>
                            <span><?php echo e(__('List of all room codes')); ?></span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="#"><?php echo e(__('Room Codes')); ?></a>
                            </li>
                        </ol>
                    </nav>
                </div>
        ...
        <div class="row">
            ...
            <div class="card">
                    <div class="card-header ">
                        <h3><?php echo e(__('All Room Codes')); ?></h3>
                        <a href="<?php echo e(route('add-room-code')); ?>" class="btn btn-info" >Add Room Codes</a>
                    </div>
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo e(__('Expires at')); ?></th>
                                        <th><?php echo e(__('Created at')); ?></th>
                                        <th><?php echo e(__('Action')); ?></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php $__currentLoopData = $codes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <th scope="row"><?php echo e($val->id); ?></th>
                                            <td><?php echo e($val->room_code); ?></td>
                                            <td><?php echo e($val->status ? 'Active' : 'Inactive'); ?></td>
                                            <td><?php echo e($val->expire_at); ?></td>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Web\sample-project\resources\views\admin\room-code\index.blade.php ENDPATH**/ ?>