    ...
    <div class="container-fluid">
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5><?php echo e(__('Edit Creator')); ?></h5>
                            <span><?php echo e(__('Edit Creator Data')); ?></span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="#"><?php echo e(__('Creator')); ?></a>
                            </li>
                            <li class="breadcrumb-item">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="<?php echo e(url('admin/creator/update')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <label for="name"><?php echo e(__('Creator name')); ?><span class="text-red">*</span></label>
...
unset($__errorArgs, $__bag); ?>" name="mobile" value="<?php echo e(clean($user->mobile, 'titles')); ?>" placeholder="Enter mobile no" required>
                                        <div class="help-block with-errors" ></div>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        <label for="email"><?php echo e(__('Description')); ?><span class="text-red">*</span></label>
...
unset($__errorArgs, $__bag); ?>" name="description" placeholder="Description" required><?php echo e(clean($user->description, 'titles')); ?></textarea>
                                        <div class="help-block with-errors" ></div>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        <img src="https://raw-celeb-bucket.s3.ap-south-1.amazonaws.com/profile/<?php echo e($user->profile_pic); ?>" width="300px" height="200px" />
                                    </div>
                                    <div class="form-group">
                                        <label for="cover_pic"><?php echo e(__('Cover Image')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        <img src="https://raw-celeb-bucket.s3.ap-south-1.amazonaws.com/cover/<?php echo e($user->cover_pic); ?>" width="300px" height="200px" />
                                    </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Web\sample-project\resources\views\admin\creator\creator-edit.blade.php ENDPATH**/ ?>