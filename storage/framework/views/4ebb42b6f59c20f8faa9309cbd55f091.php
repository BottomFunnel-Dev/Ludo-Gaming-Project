		            ...
		            <div class="card-header row">
		                ...
		                <div class="col col-sm-5">
		                    <div class="card-options text-right">
			                    ...
			                    <a href="<?php echo e(url('products/create')); ?>" class=" btn btn-outline-primary btn-semi-rounded ">Add Product</a>
		                    </div>
		                </div>
		            </div>
		            <div class="card-body">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Web\sample-project\resources\views\inventory\product\list.blade.php ENDPATH**/ ?>