...
<?php $__env->startSection('title', 'Widget Chart'); ?>
    ...
    <div class="container-fluid">
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5><?php echo e(__('Widget Chart')); ?></h5>
                ...
                <div class="col-lg-4">
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="#"><?php echo e(__('Widgets')); ?></a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page"><?php echo e(__('Chart')); ?></li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card prod-bar-card">
                    <div class="card-header">
                        <h3><?php echo e(__('Order Received')); ?></h3>
                    </div>
                    <div class="card-block">
                        <p>June - July</p>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card prod-bar-card">
                    <div class="card-header">
                        <h3><?php echo e(__('Total Sales')); ?></h3>
                    </div>
                    <div class="card-block">
                        <p>June - July</p>
                        <div class="row text-center">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card sale-card ">
                    <div class="card-header">
                        <h3><?php echo e(__('Unique Visitors')); ?></h3>
                    </div>
                    <div class="card-block text-center">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card sale-card">
                    <div class="card-header">
                        <h3><?php echo e(__('Sales Statistics')); ?></h3>
                    </div>
                    <div class="card-block text-center">
                        <div data-label="40%" class="radial-bar radial-bar-40 radial-bar-lg radial-bar-danger">
            ...
            <div class="col-md-12 col-xl-8">
                <div class="card sale-card">
                    <div class="card-header">
                        <h3><?php echo e(__('Deals Analytics')); ?></h3>
                    </div>
                    <div class="card-block">
            ...
            <div class="col-xl-4 col-md-6">
                <div class="card o-hidden">
                    <div class="card-header">
                        <h3><?php echo e(__('Sale Income')); ?></h3>
                    </div>
                    <div class="card-block">
                        <div class="row">
                            <div class="col-4">
            ...
            <div class="col-xl-4 col-md-6">
                <div class="card o-hidden">
                    <div class="card-header">
                        <h3><?php echo e(__('Rent Income')); ?></h3>
                    </div>
                    <div class="card-block">
                        <div class="row">
                            <div class="col-4">
            ...
            <div class="col-xl-4 col-md-12">
                <div class="card o-hidden">
                    <div class="card-header">
                        <h3><?php echo e(__('Income Analysis')); ?></h3>
                    </div>
                    <div class="card-block">
                        <div class="row">
                            <div class="col-4">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Web\sample-project\resources\views\pages\widget-chart.blade.php ENDPATH**/ ?>