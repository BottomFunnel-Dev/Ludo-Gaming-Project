...
<?php $__env->startSection('content'); ?>
	...
	<div class="main-area" style="padding-top:60px">
		<div class="kycPage">
			<form action="<?php echo e(url('/complete-kyc/save-step-2')); ?>" method="post" autocomplete="off">
				<?php echo csrf_field(); ?>
				...
				<div class="refer-footer"><!--<a href="<?php echo e(url('/complete-kyc/step1')); ?>" class="refer-button mr-2 cxy w-100 bg-secondary">Previous</a>
-->
...
<?php echo $__env->make('layouts.front.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Web\sample-project\resources\views\user\kyc_step2.blade.php ENDPATH**/ ?>