...
<div class="main-area" style="padding-top: 60px;">
	<?php if(is_null($user_data_details->DOCUMENT_NAME) && is_null($user_data_details->DOCUMENT_NUMBER)): ?>
	<div class="kycPage">
		...
		<form action="<?php echo e(url('/complete-kyc')); ?>" method="post">
			<?php echo csrf_field(); ?>
			<div><span style="color: rgb(149, 149, 149); font-weight: 500;">Document Type</span>
				...
				<div class="arrow cxy"><img src="<?php echo e(asset('frontend/images/global-black-chevronDown.png')); ?>" width="15px" alt=""></div> -->
			</div>
	...
	<?php elseif(is_null($user_data_details->DOCUMENT_FIRST_NAME) && !is_null($user_data_details->DOCUMENT_NAME) ): ?>
	...
	<div class="main-area">
		<div class="kycPage">
			<form action="<?php echo e(url('/complete-kyc')); ?>" method="post" autocomplete="off">
				<?php echo csrf_field(); ?>
				<div><span style="font-size: 1.5em;">Step 2</span> of 3</div>
				<p class="mt-2" style="color: rgb(149, 149, 149);">Enter details of <?php echo e($user_data_details->DOCUMENT_NAME); ?>: <span style="font-weight: 500;"><?php echo e($user_data_details->DOCUMENT_NUMBER); ?></span></p><br>
		...
		/*$(document).ready(function()
 {
	...
	<?php elseif(is_null($user_data_details->DOCUMENT_FRONT_IMAGE) && !is_null($user_data_details->DOCUMENT_FIRST_NAME) && !is_null($user_data_details->DOCUMENT_NAME)): ?>


	<div class="main-area" style="padding-top: 0px;">
		<div class="kycPage">
			<div><span style="font-size: 1.5em;">Step 3</span> of 3</div>
			<p class="mt-2" style="color: rgb(149, 149, 149);">Upload photo of <?php echo e($user_data_details->DOCUMENT_NAME); ?>: <span style="font-weight: 500;"><?php echo e($user_data_details->DOCUMENT_NUMBER); ?></span></p><br>
			<div style="margin-top: 10px;">
			...
			<form method="post" action="<?php echo e(url('/complete-kyc')); ?>" enctype="multipart/form-data">
				<?php echo csrf_field(); ?>
				<br>
...
<?php echo $__env->make('layouts.front.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Web\sample-project\resources\views\user\kycform.blade.php ENDPATH**/ ?>