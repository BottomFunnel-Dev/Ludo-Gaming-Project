...
<div class="main-area" style="padding-top: 60px;">
         ...
         <nav aria-label="pagination navigation" class="MuiPagination-root d-flex justify-content-center">
            ...
            <?php endif; ?>
               <li><a <?php if($page == 1 || $page == 0): ?> class="active" <?php endif; ?> href="/game-history?page=1">1</a></li>
               <li><a <?php if($page == 2): ?> class="active" <?php endif; ?> href="/game-history?page=2">2</a></li>
               <li><a <?php if($page == 3): ?> class="active" <?php endif; ?> href="/game-history?page=3">3</a></li>
               <li><a <?php if($page == 4): ?> class="active" <?php endif; ?> href="/game-history?page=4">4</a></li>
               <li><a <?php if($page == 5): ?> class="active" <?php endif; ?> href="/game-history?page=5">5</a></li>
      ...
      <span class="text-capitalize me-2 py-2 px-4 border text-dark badge rounded-pill" style="cursor: pointer;"onclick="myFunction3()">Referral</span>
         ...
         <?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                    
                        <?php switch($val->status):
                          case ('Create'): ?>
                            <?php if($val->challenge->status == 0 && (isset($val->challengeresult->is_cancel) && $val->challengeresult->is_cancel == 0) && ($val->challengeresult->user_id != Auth::user()->id )): ?>
                            ...
                            <div class="w-100 py-3 d-flex align-items-center list-item">
                              ...
                              <div class="mx-3 d-flex list-body">
                                ...
                                <div class="d-flex flex-column font-8">Lost against <?php echo e($val->challenge->oname); ?>   <div class="games-section-headline">Order ID:
                              ...
                              <div class="right-0 d-flex align-items-end pr-3 flex-column">
                                ...
                                <div class="games-section-headline" style="font-size: 0.6em;">Closing Balance: <?php echo e($val->closing_balance); ?></div> 
                              </div>
                            </div>
                          ...
                          <?php case ('Play'): ?>
                            ...
                            <div class="w-100 py-3 d-flex align-items-center list-item">
                              ...
                              <div class="mx-3 d-flex list-body">
                                <div class="d-flex align-items-center"></div>
                                <div class="d-flex flex-column font-8">Lost against <?php echo e($val->challenge->cname); ?>     <div class="games-section-headline">Order ID:
                                      <?php echo e($val->source_id); ?></div>
                                </div>
                              </div>
                              <div class="right-0 d-flex align-items-end pr-3 flex-column">
                          ...
                          <div class="w-100 py-3 d-flex align-items-center list-item">
                              ...
                              <div class="mx-3 d-flex list-body">
                                ...
                                <div class="d-flex flex-column font-8">
                                  ...
                                  <?php if(isset($val->challenge) && $val->challenge->c_id == Auth::user()->id): ?>
                                    <?php echo e($val->challenge->oname); ?>

                                  <?php elseif(isset($val->challenge) && $val->challenge->o_id == Auth::user()->id): ?>
                                    <?php echo e($val->challenge->cname); ?>
...
<?php echo $__env->make('layouts.front.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Web\sample-project\resources\views\user\game-history.blade.php ENDPATH**/ ?>