        ...
        <script>
            $(function() {
                ...
                socket.on('createChallengeClient', (data) => {
                    ...
                    let myid = <?php echo e(Auth::user()->id); ?>;
                    if (data.c_id != myid) {
...
<?php echo $__env->make('layouts.front.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Web\sample-project\resources\views/user/challenges2.blade.php ENDPATH**/ ?>