    ...
    <div class="leftContainer splash-bg login-page-bg" style="background-image:url(././front/images/splash-bg.png);">
        ...
        <div class="main-area">
            ...
            <div class="position-absolute w-100 center-xy mx-auto sign-otp">
                <form id="login-form" method="POST" action="<?php echo e(route('login')); ?>">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="referral" value="<?php echo e($referral); ?>" />
                ...
                <p style="color:white;margin-left:50px;margin-right:30px">By proceeding, you agree to our <a
                        href="<?php echo e(route('front.terms-and-conditions')); ?>">Terms of Use</a>, <a
                        href="<?php echo e(route('front.privacy-policy')); ?>">Privacy Policy</a> and that you are 18 years or
        ...
        <div class="rightContainer">
            <div class="rcBanner flex-center">
                <div class="rcBanner-img-container"><img src="<?php echo e(asset('front/images/khelmoj123.png')); ?>"
                        alt=""></div>
...
<?php /**PATH C:\Web\sample-project\resources\views\auth\front\login.blade.php ENDPATH**/ ?>