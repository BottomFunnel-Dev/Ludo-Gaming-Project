			...
			<div class="row">
				<div class="col-md-12 buy-chips-content">
					...
					<div class="container text-center result-container">
						...
						<h2><b id="wait-rrom-code" class="blink_me" style="font-size: 18px;">Congratulation! You are at Level <?php echo e($contest->current_level); ?></b>
						<b><a class="pull-right" style="text-decoration:none;font-size:18px" href="route('dashboard.contests')" >Contests</a></b></h2>
                            <hr>
							
							<h4 id="res-room-id">Your Room Code is : <?php echo e(@$rcode); ?></h4>
						...
						<form action="<?php echo e(route('dashboard.contest-submit-result')); ?>" method="POST"  enctype="multipart/form-data">

							<input type="hidden" name="room_code" value="<?php echo e($rcode); ?>" >
							<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
							<input type="hidden" name="slug" value=" <?php echo e($contest->slug); ?>">
							<input type="hidden" name="level" value=" <?php echo e($contest->current_level); ?>">
...
<?php echo $__env->make('layouts.front.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Web\sample-project\resources\views\user\contest-result.blade.php ENDPATH**/ ?>