...
<div class="main-area" style="padding-top: 60px;">
	<div class="kycPage">
		...
		<div id="UID" class="inv">
			<form action="<?php echo e(url('/complete-kyc/save-step-1')); ?>" method="post">
				<?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.front.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Web\sample-project\resources\views\user\kyc_step1.blade.php ENDPATH**/ ?>