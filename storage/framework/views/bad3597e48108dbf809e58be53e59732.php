...
-->
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
					  <?php if($val->w_id == Auth::user()->id): ?>
						<span class="badge badge-success" style="background-color:green;">You Won</span>
						<?php elseif($val->w_id != Auth::user()->id): ?>
						<span class="badge badge-success" style="background-color:green;"><?php echo e($val->winnername->username ?? 'N/A'); ?> Won </span>
                  ...
                  <td>
					  <?php if($val->status == 'COMPLETED'): ?>
						  <span class="badge badge-info" style="background-color:green;"><?php echo e($val->status); ?></span>
					  <?php elseif($val->status == 'PENDING' || $val->status == 'CANCELLED' || $val->status == 'HOLD'): ?>
						<span class="badge badge-danger" style="background-color:red;"><?php echo e($val->status); ?></span>
					  <?php elseif($val->status == 'PLAYING'): ?>
...
<?php echo $__env->make('layouts.front.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Web\sample-project\resources\views\user\recently-played.blade.php ENDPATH**/ ?>