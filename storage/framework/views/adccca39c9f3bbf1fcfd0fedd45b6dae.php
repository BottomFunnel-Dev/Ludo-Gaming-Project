      ...
      <div class="px-4 py-3">
        <div class="mb-2"><img src="<?php echo e(asset('front/images/award-blue.png')); ?>" width="20px" alt=""><span
          ...
          <span class="games-section-headline text-uppercase position-relative mt-2 font-weight-bold float-right" style="top: -0.2rem;">
            <a href="<?php echo e(route('front.game-rules')); ?>">Rules <i class="fa fa-info-circle" aria-hidden="true"></i></a></span></div>
  ...
  <script src="https://code.jquery.com/jquery-3.6.0.js" integrity="sha256-H+K7U5CnXl1h5ywQfKtSj8PCmoN9aaq30gDh27Xc0jk=" crossorigin="anonymous"></script>
	...
	<script>
		...
		function listChallengeCre(data){
			...
			html	+='<img class="mx-1" src="<?php echo e(asset('front/images/global-rupeeIcon.png')); ?>" width="21px" alt="">'+data.amount+'</span><div class="betCard-title d-flex align-items-center text-uppercase">';
			...
			html	+='</span></div></div><div class="py-1 row"><div class="pr-3 text-center col-5"><div class="pl-2"><img class="border-50" src="<?php echo e(asset('front/images/author.svg')); ?>" width="21px" height="21px" alt=""></div>';
			html	+='<div style="line-height: 1;"><span class="betCard-playerName">'+data.cname+'</span></div></div><div class="pr-3 text-center col-2 cxy">';
			html	+='<div><img src="<?php echo e(asset('front/images/vs.png')); ?>" width="30px" alt=""></div></div><div class="text-center col-5"><div class="pl-2">';
			html	+='<img class="border-50" id="'+data.id+'-loading" src="<?php echo e(asset('front/images/small-loading.gif')); ?>" width="21px" height="21px" alt=""></div><div style="line-height: 1;"><span class="betCard-playerName" id="'+data.id+'-finding">Finding Player</span></div></div></div></div></div>';
		...
		function playingGameHtml(data){
			...
			html	+='<img class="mx-1" src="<?php echo e(asset('front/images/global-rupeeIcon.png')); ?>" width="21px" alt="">'+data.amount+'</span><div class="betCard-title d-flex align-items-center text-uppercase"><span class="ml-auto mr-3">PRIZE';
			html	+='<img  class="mx-1" src="<?php echo e(asset('front/images/global-rupeeIcon.png')); ?>" width="21px" alt="">'+prize+'</span></div></div><div class="py-1 row"><div class="pr-3 text-center col-5">';
			html	+='<div class="pl-2"><img class="border-50" src="<?php echo e(asset('front/images/author.svg')); ?>" width="21px" height="21px" alt=""></div>';
			html	+='<div style="line-height: 1;"><span class="betCard-playerName">'+data.cname+'</span></div></div><div class="pr-3 text-center col-2 cxy">';
			html	+='<div><img src="<?php echo e(asset('front/images/vs.png')); ?>" width="30px" alt=""></div></div><div class="text-center col-5">';
			html	+='<div class="pl-2"><img class="border-50" src="<?php echo e(asset('front/images/author.svg')); ?>" width="21px" height="21px" alt=""></div>';
		...
		function acceptDenyHtml(data){
			...
			var prize	=	getPrizeAmount(data.amount);
			html	+='<div id="pp2"><div id="chdiv-'+data.id+'" class="betCard mt-1"><div class="d-flex"><span class="betCard-title pl-3 d-flex align-items-center text-uppercase">PLAYING FOR';
			html	+='<img class="mx-1" src="<?php echo e(asset('front/images/global-rupeeIcon.png')); ?>" width="21px" alt="">'+prize+'</span><div class="betCard-title d-flex align-items-center text-uppercase">';
			...
			html	+='<div style="line-height: 1;"><span class="betCard-playerName">'+data.cname+'</span></div></div><div class="pr-3 text-center col-2 cxy">';
			html	+='<div><img src="<?php echo e(asset('front/images/vs.png')); ?>" width="30px" alt=""></div></div><div class="text-center col-5"><div class="pl-2">';
			html	+='<img class="border-50" src="<?php echo e(asset('front/images/author.svg')); ?>" width="21px" height="21px" alt=""></div><div style="line-height: 1;"><span class="betCard-playerName">'+data.oname+'</span></div></div></div></div></div>';
			return html;
		}
		...
		function startGameHtml(data){
			...
			html 	+='<div class="d-flex pl-3"><div class="pr-3 pb-1"><span class="betCard-subTitle">Entry Fee</span><div><img src="<?php echo e(asset('front/images/global-rupeeIcon.png')); ?>" width="21px" alt=""><span class="betCard-amount">'+data.amount+'</span>';
			html 	+='</div></div><div><span class="betCard-subTitle">Prize</span><div><img src="<?php echo e(asset('front/images/global-rupeeIcon.png')); ?>" width="21px" alt=""><span class="betCard-amount">'+prize+'</span>';
		...
		function viewGameHtml(data){
			...
			html	+='<img class="mx-1" src="<?php echo e(asset('front/images/global-rupeeIcon.png')); ?>" width="21px" alt="">'+prize+'</span><div class="betCard-title d-flex align-items-center text-uppercase">';
			html	+='<span class="ml-auto"><a href="<?php echo e(route('challenge-detail','+data.id+')); ?>"  class="btn btn-info px-3 btn-sm" >View</a>	</span></div></div>';
			html	+='<div class="py-1 row"><div class="pr-3 text-center col-5"><div class="pl-2"><img class="border-50" src="<?php echo e(asset('front/images/author.svg')); ?>" width="21px" height="21px" alt=""></div>';
			html	+='<div style="line-height: 1;"><span class="betCard-playerName">'+data.cname+'</span></div></div><div class="pr-3 text-center col-2 cxy">';
			html	+='<div><img src="<?php echo e(asset('front/images/vs.png')); ?>" width="30px" alt=""></div></div><div class="text-center col-5">';
			html	+='<div class="pl-2"><img class="border-50" src="<?php echo e(asset('front/images/author.svg')); ?>" width="21px" height="21px" alt=""></div>';
			html	+='<div style="line-height: 1;"><span class="betCard-playerName">'+data.oname+'</span></div></div></div></div></div>';
		...
		function playChallengeSoc(data){
			...
			if(data.c_id == user_id){ 
				...
				loading.setAttribute("src","<?php echo e(asset('front/images/author.svg')); ?>");
		...
		function setChallengsOpen(challenges){
			...
			for (let i = 0; i < challenges.length; i++) {
				...
				if(challenges[i].c_id == user_id){					
					...
					html	+='<img class="mx-1" src="<?php echo e(asset('front/images/global-rupeeIcon.png')); ?>" width="21px" alt="">'+challenges[i].amount+'</span><div class="betCard-title d-flex align-items-center text-uppercase">';
					...
					html	+='<div><img src="<?php echo e(asset('front/images/vs.png')); ?>" width="30px" alt=""></div></div><div class="text-center col-5"><div class="pl-2">';
					html	+='<img class="border-50" id="'+challenges[i].id+'-loading" src="<?php echo e(asset('front/images/small-loading.gif')); ?>" width="21px" height="21px" alt=""></div><div style="line-height: 1;"><span class="betCard-playerName" id="'+challenges[i].id+'-finding">Finding Player</span></div></div></div></div></div>';
				}else{
					...
					html	+='<div class="d-flex pl-3"><div class="pr-3 pb-1"><span class="betCard-subTitle">Entry Fee</span>';
					html	+='<div class="global-rupee-icon"><img src="<?php echo e(asset('front/images/global-rupeeIcon.png')); ?>" width="21px" alt=""><span class="betCard-amount">'+challenges[i].amount+'</span></div></div>';
					html	+='<div><span class="betCard-subTitle">Prize</span><div><img src="<?php echo e(asset('front/images/global-rupeeIcon.png')); ?>" width="21px" alt=""><span class="betCard-amount">'+prize+'</span></div>';
		...
		function setMyChallenges(myChallenges){
			...
			for (let i = 0; i < myChallenges.length; i++) {
				...
				if(myChallenges[i].status == 1 && myChallenges[i].c_id == user_id){
					...
					html	+='<img class="mx-1" src="<?php echo e(asset('front/images/global-rupeeIcon.png')); ?>" width="21px" alt="">'+myChallenges[i].amount+'</span><div class="betCard-title d-flex align-items-center text-uppercase">';
					...
					html	+='<div><img src="<?php echo e(asset('front/images/vs.png')); ?>" width="30px" alt=""></div></div><div class="text-center col-5"><div class="pl-2">';
					html	+='<img class="border-50" id="'+myChallenges[i].id+'-loading" src="<?php echo e(asset('front/images/small-loading.gif')); ?>" width="21px" height="21px" alt=""></div><div style="line-height: 1;"><span class="betCard-playerName" id="'+myChallenges[i].id+'-finding">Finding Player</span></div></div></div></div></div>';
					...
					html	+='<div class="d-flex pl-3"><div class="pr-3 pb-1"><span class="betCard-subTitle">Entry Fee</span>';
					html	+='<div class="global-rupee-icon"><img src="<?php echo e(asset('front/images/global-rupeeIcon.png')); ?>" width="21px" alt=""><span class="betCard-amount">'+myChallenges[i].amount+'</span></div></div>';
					html	+='<div><span class="betCard-subTitle">Prize</span><div><img src="<?php echo e(asset('front/images/global-rupeeIcon.png')); ?>" width="21px" alt=""><span class="betCard-amount">'+prize+'</span></div>';
					...
					html	+='<div style="line-height: 1;"><span class="betCard-playerName">'+myChallenges[i].cname+'</span></div></div><div class="pr-3 text-center col-2 cxy">';
					html	+='<div><img src="<?php echo e(asset('front/images/vs.png')); ?>" width="30px" alt=""></div></div><div class="text-center col-5"><div class="pl-2">';
					html	+='<img class="border-50" src="<?php echo e(asset('front/images/author.svg')); ?>" width="21px" height="21px" alt=""></div><div style="line-height: 1;"><span class="betCard-playerName">'+myChallenges[i].oname+'</span></div></div></div></div></div>';
					...
					html	+='<div class="d-flex pl-3"><div class="pr-3 pb-1"><span class="betCard-subTitle">Entry Fee</span><div><img src="<?php echo e(asset('front/images/global-rupeeIcon.png')); ?>" width="21px" alt=""><span class="betCard-amount">'+myChallenges[i].amount+'</span></div></div>';
					html	+='<div><span class="betCard-subTitle">Prize</span><div><img src="<?php echo e(asset('front/images/global-rupeeIcon.png')); ?>" width="21px" alt=""><span class="betCard-amount">'+prize+'</span>';
					...
					html    +='<div class="d-flex pl-3"><div class="pr-3 pb-1"><span class="betCard-subTitle">Entry Fee</span><div><img src="<?php echo e(asset('front/images/global-rupeeIcon.png')); ?>" width="21px" alt=""><span class="betCard-amount">'+myChallenges[i].amount+'</span>';
					html    +='</div></div><div><span class="betCard-subTitle">Prize</span><div><img src="<?php echo e(asset('front/images/global-rupeeIcon.png')); ?>" width="21px" alt=""><span class="betCard-amount">'+prize+'</span>';
...
<?php echo $__env->make('layouts.front.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Web\sample-project\resources\views\user\old_challenges.blade.php ENDPATH**/ ?>