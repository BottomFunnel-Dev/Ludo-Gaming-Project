...
<div class="main-area" style="padding-top: 60px;"><div class="cxy flex-column mx-4" style="margin-top: 70px;"><img src="<?php echo e(asset('front/images/support.jpg')); ?>" width="280px" alt=""><div class="games-section-title mt-4 text-center" style="font-size: 1em;">
...
<?php echo $__env->make('layouts.front.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Web\sample-project\resources\views\user\support.blade.php ENDPATH**/ ?>