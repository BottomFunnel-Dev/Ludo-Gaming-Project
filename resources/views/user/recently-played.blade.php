...
-->
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
					  @if($val->w_id == Auth::user()->id)
						<span class="badge badge-success" style="background-color:green;">You Won</span>
						@elseif($val->w_id != Auth::user()->id)
						<span class="badge badge-success" style="background-color:green;">{{$val->winnername->username ?? 'N/A'}} Won </span>
                  ...
                  <td>
					  @if($val->status == 'COMPLETED')
						  <span class="badge badge-info" style="background-color:green;">{{$val->status}}</span>
					  @elseif($val->status == 'PENDING' || $val->status == 'CANCELLED' || $val->status == 'HOLD')
						<span class="badge badge-danger" style="background-color:red;">{{$val->status}}</span>
					  @elseif($val->status == 'PLAYING')
						<span class="badge badge-success" style="background-color:green;">{{$val->status}}</span>
					  @endif
				  </td>
                  <td>{{$val->amount}}</td>
