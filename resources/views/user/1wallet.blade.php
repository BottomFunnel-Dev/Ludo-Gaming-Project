...
<div class="main-area" style="padding-top: 60px;">
         ...
         <div class="p-4 bg-light">
            <div class="wallet-card h-100">
               ...
               <a href="{{url('add-money')}}" class="btn btn-primary text-white w-100 mt-2" style="font-size: 0.9em;">Add</a>
            </div>
            <div class="wallet-card h-100">
               ...
               <a href="{{url('withdraw-request')}}" class="btn btn-primary text-white w-100 mt-2" style="font-size: 0.9em;">Withdraw</a>
            </div>
         </div>
      </div>
   </div>
