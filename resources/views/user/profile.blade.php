        ...
        <div class="p-3" style="background: rgb(250, 250, 250);">
            ...
            <div class="center-xy py-2">
                ...
                <div class="text-bold my-3" id="profile-edit-div"><span
                        id="player-username">{{ Auth::user()->username }}</span><img class="ml-2" id="profile-edit-icon"
                        width="20px" src="{{ asset('front/images/icon-edit.jpg') }}" alt=""
                ...
                <div class="text-bold my-3" id="profile-username-div" style="display:none">
                    <form action="javascript:void(0)" id="change-unique-id" method="POST">
                        <input class="profile-wallet" name="username" value="{{ Auth::user()->username }}"
                            ...
                            @if ($userData[0]->verify_status == 1)
                                <a class="d-flex align-items-center profile-wallet bg-light mx-1 my-4 py-3"
                                    ...
                                    <picture class="ml-4"><img width="32px"
                                            src="{{ asset('frontend/images/kyc-icon-new.png') }}" alt=""></picture>
                                    <div class="ml-5 mytext text-muted "><span style="float:left; margin-top:8px;">KYC
                                            Completed &nbsp; </span><img src="{{ asset('/backend/img/approved.png') }}"
                                            style="width:35px;"></div>
                                </a>
                            @elseif($userData[0]->verify_status == null || $userData[0]->verify_status == 0)
                                <a class="d-flex align-items-center profile-wallet bg-light mx-1 my-4 py-3"
                                    href="{{ url('/complete-kyc/step1') }}">
                                    <picture class="ml-4"><img width="32px"
                                            src="{{ asset('frontend/images/kyc-icon-new.png') }}" alt=""></picture>
                                    <div class="ml-5 mytext text-muted "><span style="float:left; margin-top:8px;">KYC
                                            Rejected &nbsp; </span><img src="{{ asset('/backend/img/rejected.png') }}"
                                            style="width:35px;"></div>
                                </a>
                            @elseif($userData[0]->verify_status == 2)
                                <a class="d-flex align-items-center profile-wallet bg-light mx-1 my-4 py-3"
                                    href="{{ url('complete-kyc/kyc-submit') }}">
                                    <picture class="ml-4"><img width="32px"
                                            src="{{ asset('frontend/images/kyc-icon-new.png') }}" alt=""></picture>
                                    <div class="ml-5 mytext text-muted "><span style="float:left; margin-top:8px;">KYC Under
                                            Review&nbsp; </span><img src="{{ asset('/backend/img/under_review.png') }}"
                                            style="width:35px;"></div>
                                </a>
                            @else
                                <a class="d-flex align-items-center profile-wallet bg-light mx-1 my-4 py-3"
