...
<div class="main-area" style="padding-top: 60px;">
    @if ($transactions->hasPages())
         <nav aria-label="pagination navigation" class="MuiPagination-root d-flex justify-content-center">
            ...
            @endif
               <li><a @if($page == 1 || $page == 0) class="active" @endif href="/transactions?page=1">1</a></li>
               <li><a @if($page == 2) class="active" @endif href="/transactions?page=2">2</a></li>
               <li><a @if($page == 3) class="active" @endif href="/transactions?page=3">3</a></li>
               <li><a @if($page == 4) class="active" @endif href="/transactions?page=4">4</a></li>
               <li><a @if($page == 5) class="active" @endif href="/transactions?page=5">5</a></li>
                        ...
                        @switch($val->status)
                          @case('Wallet')
                            <div class="w-100 py-3 d-flex align-items-center list-item">
                             ...
                             <div class="games-section-headline" style="font-size: 0.5em;">Closing Balance:   {{$val->closing_balance}}</div> 
                              </div>
                            </div>
                            @break
                          @case('Admin_add')
                          ...
                          @case('balance')
                            <div class="w-100 py-3 d-flex align-items-center list-item">
                              <div class="center-xy list-date mx-2" id="message">
                                <div>{{ date("d M", strtotime($balance->created_at))}}</div><small>{{ date("H:i A", strtotime($val->created_at))}}</small>
                              </div>
                              <div class="list-divider-y"></div>
                              <div class="mx-3 d-flex list-body">
                                <div class="d-flex align-items-center"></div>
                              ...
                              <div class="right-0 d-flex align-items-end pr-3 flex-column">
                                <div class="d-flex float-right font-8">
                                    <div class="text-success">(+)</div>
                                    <div class="ml-1 mb-1"><img height="21px" width="21px" src="{{ asset('front/images/global-rupeeIcon.png')}}" alt="">
                                    </div><span class="pl-1">{{$balance}}</span>
                                </div>
                             <div class="games-section-headline" style="font-size: 0.5em;">Closing Balance:   {{$val->closing_balance}}</div> 
                              </div>
                            </div>
